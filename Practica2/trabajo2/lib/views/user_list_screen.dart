...
class UserListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /// Obtiene el ViewModel usando Provider.
    /// context.watch() reconstruirá la UI cuando notifyListeners() sea llamado.
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        /// Filtro en el AppBar para mostrar solo usuarios activos.
        actions: [
          Row(
            children: [
